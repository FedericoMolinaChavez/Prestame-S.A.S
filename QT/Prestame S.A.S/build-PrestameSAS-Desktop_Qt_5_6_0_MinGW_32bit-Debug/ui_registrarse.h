...
public:
    ...
    void setupUi(QDialog *registrarse)
    {
        ...
        lineEdit_1Nombre->setGeometry(QRect(20, 40, 321, 20));
        ...
        pushButton_1Siguiente->setGeometry(QRect(490, 420, 91, 31));
        pushButton_1Siguiente->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        pushButton_2Cancelar->setGeometry(QRect(590, 420, 91, 31));
        ...
        QObject::connect(pushButton_1Siguiente, SIGNAL(clicked()), registrarse, SLOT(close()));
    ...
    {
        registrarse->setWindowTitle(QApplication::translate("registrarse", "Registrarse", 0));
        ...
        pushButton_1Siguiente->setText(QApplication::translate("registrarse", "Siguiente", 0));
